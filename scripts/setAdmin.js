 ...
 *   3. Placer le fichier JSON dans le dossier functions/
 */
...
// Chercher dans functions/ d'abord, puis à la racine
...
async function setAdmin(email) {
  try {
    ...
    console.log(`3. User will see "Create User" and "Invite User" buttons`);
